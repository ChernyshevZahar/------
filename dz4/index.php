...
$works = [
    ...
    [
        "work" => "Веб-разработчик / something.com",
        "Fisrt time" => "март 2012 г. - декабрь 2014 г.",
        "Last time" => "",
        "discription" => "Lorem ipsum dolor sit amet. Praesentium magnam consectetur vel in deserunt aspernatur est reprehenderit
        sunt hic. Nulla tempora soluta ea et odio, unde doloremque repellendus iure, iste."
    ],
    [
        "work" => "Графический дизайнер / designsomething.comк",
        "Fisrt time" => "июнь 2010 г. - март 2012 г.",
        "Last time" => "",
        "discription" => "Lorem ipsum dolor sit amet. Praesentium magnam consectetur vel in deserunt aspernatur est reprehenderit
        sunt hic. Nulla tempora soluta ea et odio, unde doloremque repellendus iure, iste."
    ],
    ...
    <div class="w3-row-padding">
      ...
      <div class="w3-twothird">
        ...
        <?php for ($i=0; $i < count($works) ; $i++): ?>
          <div class="w3-container"><?php echo $works[$i]['work']?> </b></h5>
            <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $works[$i]['Fisrt time']?> <span
                class="w3-tag w3-teal w3-round"><?php echo $works[$i]['Last time']?> </span></h6>
            <p><?php echo $works[$i]['discription']?> </p>
            <hr>
          </div>
        <?php endfor; ?>
